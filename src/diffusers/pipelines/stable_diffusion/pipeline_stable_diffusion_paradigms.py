...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> scheduler = DDPMParallelScheduler.from_pretrained("Lykon/dreamshaper-8", subfolder="scheduler")

        >>> pipe = StableDiffusionParadigmsPipeline.from_pretrained(
        ...     "Lykon/dreamshaper-8", scheduler=scheduler, torch_dtype=torch.float16
        ... )
        >>> pipe = pipe.to("cuda")
