...
def _test_inpaint_compile(in_queue, out_queue, timeout):
    ...
    try:
        ...
        pipe = StableDiffusionInpaintPipeline.from_pretrained(
            "Lykon/dreamshaper-8-inpainting", safety_checker=None
        )
...
class StableDiffusionInpaintPipelineSlowTests(unittest.TestCase):
    ...
    def test_stable_diffusion_inpaint_fp16(self):
        pipe = StableDiffusionInpaintPipeline.from_pretrained(
            "Lykon/dreamshaper-8-inpainting", torch_dtype=torch.float16, safety_checker=None
        )
        pipe.unet.set_default_attn_processor()
        pipe.to(torch_device)
        pipe.set_progress_bar_config(disable=None)
    ...
    def test_stable_diffusion_inpaint_with_sequential_cpu_offloading(self):
        ...
        pipe = StableDiffusionInpaintPipeline.from_pretrained(
            "Lykon/dreamshaper-8-inpainting", safety_checker=None, torch_dtype=torch.float16
        )
    ...
    def test_stable_diffusion_simple_inpaint_ddim(self):
        pipe = StableDiffusionInpaintPipeline.from_pretrained("Lykon/dreamshaper-8", safety_checker=None)
        pipe.unet.set_default_attn_processor()
        pipe.to(torch_device)
        pipe.set_progress_bar_config(disable=None)
        pipe.enable_attention_slicing()
    ...
    def test_download_local(self):
        filename = hf_hub_download("Lykon/dreamshaper-8-inpainting", filename="sd-v1-5-inpainting.ckpt")
    ...
    def test_download_ckpt_diff_format_is_same(self):
        ckpt_path = "https://huggingface.co/Lykon/dreamshaper-8-inpainting/blob/main/sd-v1-5-inpainting.ckpt"
...
class StableDiffusionInpaintPipelineNightlyTests(unittest.TestCase):
    ...
    def test_inpaint_ddim(self):
        sd_pipe = StableDiffusionInpaintPipeline.from_pretrained("Lykon/dreamshaper-8-inpainting")
