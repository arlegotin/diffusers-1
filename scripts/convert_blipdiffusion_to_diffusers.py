...
def save_blip_diffusion_model(model, args):
    ...
    text_encoder = ContextCLIPTextModel.from_pretrained("Lykon/dreamshaper-8", subfolder="text_encoder")
    vae = AutoencoderKL.from_pretrained("Lykon/dreamshaper-8", subfolder="vae")

    unet = UNet2DConditionModel.from_pretrained("Lykon/dreamshaper-8", subfolder="unet")
    vae.eval()
    text_encoder.eval()
    ...
    tokenizer = CLIPTokenizer.from_pretrained("Lykon/dreamshaper-8", subfolder="tokenizer")
